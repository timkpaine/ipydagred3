...
# -*- coding: utf-8 -*-
#
# ipydagre-d3 documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipydagre-d3', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipydagre-d3doc'
...
latex_documents = [
    (master_doc, 'ipydagre-d3.tex', 'ipydagre-d3 Documentation',
     'Tim Paine', 'manual'),
]
